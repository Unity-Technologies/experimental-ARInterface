...
#region ARCoreCameraAPI
        ...
        public override void Update()
        {
            ...
            foreach (var trackedPlane in m_TrackedPlaneBuffer)
            {
                ...
                {
                    boundedPlane = new BoundedPlane(Guid.NewGuid().ToString(), trackedPlane.Position,
                            trackedPlane.Rotation, new Vector2(trackedPlane.ExtentX, trackedPlane.ExtentZ), trackedPlane);
